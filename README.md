...
flowchart TD  
    ...
    %% Styling (진한 배경, 흰색 굵은 글씨)
    classDef input fill:#1565c0,stroke:#fff,stroke-width:2px, color:#fff, font-weight:bold;
    classDef preproc fill:#1976d2,stroke:#fff,stroke-width:2px, color:#fff, font-weight:bold;
    classDef vision fill:#0d47a1,stroke:#fff,stroke-width:2px, color:#fff, font-weight:bold;
    classDef action fill:#2e7d32,stroke:#fff,stroke-width:2px, color:#fff, font-weight:bold;
    classDef event fill:#0277bd,stroke:#fff,stroke-width:2px, color:#fff, font-weight:bold;
    classDef metrics fill:#558b2f,stroke:#fff,stroke-width:2px, color:#fff, font-weight:bold;
    classDef content fill:#e65100,stroke:#fff,stroke-width:2px, color:#fff, font-weight:bold;
    classDef output fill:#6d4c41,stroke:#fff,stroke-width:2px, color:#fff, font-weight:bold;
    classDef delivery fill:#424242,stroke:#fff,stroke-width:2px, color:#fff, font-weight:bold;
